    ...
    if model_deployment_name is not None:
        with agents_client:
            ...
            agent_team.set_team_leader(
                ...
                Let me be clear. I DO NOT want the final thing you as the TeamLeader producing to be a concatenation of every string the sub-agents responded with. 
                I'd like you to format the 4 responses nicely in markdown, with sections for PAV, PPA, SUP, and DUP analysis. The sub-agents provide the analysis, you format their responses into one coherent report with sections, formatted in markdown
